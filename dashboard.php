...
<head>
  ...
  <title> Toko Citra - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php?p=halaman_awal">
        ...
        <div class="sidebar-brand-text mx-3">TOKO CITRA</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_barang">
          <i class="fas fa-fw fa-table"></i>
          <span>Data Barang</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_training">
          <i class="far fa-fw fa-window-maximize"></i>
          <span>Data Training</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_peramalan">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="dashboard.php?p=laporan_peramalan">Laporan Peramalan</a>
          </div>
        </div>
      </li>
    </ul>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> Toko Citra
