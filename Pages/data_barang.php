                ...
                <div class="card-body">
                  ...
                  <table class="table align-items-center table-hover table-bordered" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                         <td><?php echo $no;?></td>
                         <td><?php echo $data_user['kode_barang'];?></td>
                         <td><?php echo $data_user['barcode'];?></td>
                         <td><?php echo $data_user['nama_barang'];?></td>
                         <td><?php echo $data_user['stok'];?></td>
                         <td><?php echo $data_user['satuan'];?></td>
                         <td><?php echo $data_user['rak'];?></td>
                         <td><?php 
                              ...
                              <td><?php 
                                $hj= $data_user['harga_jual'];
                                echo "Rp.".number_format($hj, 2, ".", ".");
                                ?> 
                              </td>
                         <td><a href="dashboard.php?p=edit_data_barang&id=<?php echo $data_user['kode_barang'];?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                         </td>
                      </tr>
                      <?php $no++;}
                      ?>
